...
import com.example.album_admin.adapter.ApproveEnquiryAdapter;
 ...
 */
public class ApproveEnquiryFragment extends Fragment implements ApproveEnquiryInterface {
    public RecyclerView recyclerView;
    public FloatingActionButton fab;
    public SwipeRefreshLayout swipeRefreshLayout;
    ArrayList<SpCakeAndAlbumEnquiry> enquiryList = new ArrayList<>();
    ArrayList<SpCakeAndAlbumEnquiry> enqApproveList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_approve_enquiry, container, false);
    ...
    private void getEnquiry(String fromDate,String toDate) {
        ...
        if (Constants.isOnline(getActivity())) {
            ...
            Call<ArrayList<SpCakeAndAlbumEnquiry>> listCall = Constants.myInterface.getSpCakeEnaAlbmFrDetail(fromDate,toDate);
            listCall.enqueue(new Callback<ArrayList<SpCakeAndAlbumEnquiry>>() {
                @Override
                public void onResponse(Call<ArrayList<SpCakeAndAlbumEnquiry>> call, Response<ArrayList<SpCakeAndAlbumEnquiry>> response) {
                    try {
                        if (response.body() != null) {
                            ...
                            for(int i=0;i<enquiryList.size();i++)
                            {
                                ...
                                {
                                    enqApproveList.add(enquiryList.get(i));
                                }
                            }

                            Log.e("Enquiry List Model : ", "******************************APPROVE******************************" +enqApproveList);

                            ApproveEnquiryAdapter mAdapter = new ApproveEnquiryAdapter(enqApproveList, getActivity());
                ...
                @Override
                public void onFailure(Call<ArrayList<SpCakeAndAlbumEnquiry>> call, Throwable t) {
                    commonDialog.dismiss();
